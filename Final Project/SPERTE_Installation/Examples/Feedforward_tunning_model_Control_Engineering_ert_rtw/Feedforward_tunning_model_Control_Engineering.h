...
typedef struct {
  ...
  real_T SFunction[3];                 /* '<S9>/S-Function' */
  ...
  real_T Output;                       /* '<Root>/Select encoder' */
  real_T Error;                        /* '<Root>/Sum' */
  real_T Gain1;                        /* '<S8>/Gain1' */
  real_T Dctleadlag2;                  /* '<S8>/Dctleadlag2' */
  real_T Dctnotch3;                    /* '<S8>/Dctnotch3' */
  real_T Dct1lowpass4;                 /* '<S8>/Dct1lowpass4' */
  real_T Dctnotch5;                    /* '<S8>/Dctnotch5' */
  real_T Dctnotch6;                    /* '<S8>/Dctnotch6' */
  real_T Dctintegrator7;               /* '<S8>/Dctintegrator7' */
...
typedef struct {
  ...
  real_T Dctleadlag2_RWORK[2];         /* '<S8>/Dctleadlag2' */
  real_T Dctnotch3_RWORK[4];           /* '<S8>/Dctnotch3' */
  real_T Dct1lowpass4_RWORK[2];        /* '<S8>/Dct1lowpass4' */
  real_T Dctnotch5_RWORK[4];           /* '<S8>/Dctnotch5' */
  real_T Dctnotch6_RWORK[4];           /* '<S8>/Dctnotch6' */
  real_T Dctintegrator7_RWORK[2];      /* '<S8>/Dctintegrator7' */
  struct {
    void *LoggedData;
...
struct P_Feedforward_tunning_model_Control_Engineering_T_ {
  ...
  real_T Dctnotch6_P5;                 /* Expression: 0.001
                                        * Referenced by: '<S8>/Dctnotch6'
                                        */
  real_T Dctintegrator7_P1_Size[2];/* Computed Parameter: Dctintegrator7_P1_Size
                                    * Referenced by: '<S8>/Dctintegrator7'
                                    */
  real_T Dctintegrator7_P1;            /* Expression: f_num
                                        * Referenced by: '<S8>/Dctintegrator7'
                                        */
  real_T Dctintegrator7_P2_Size[2];/* Computed Parameter: Dctintegrator7_P2_Size
                                    * Referenced by: '<S8>/Dctintegrator7'
                                    */
  real_T Dctintegrator7_P2;            /* Expression: 0.001
                                        * Referenced by: '<S8>/Dctintegrator7'
                                        */
 ...
 * '<S8>'   : 'Feedforward_tunning_model_Control_Engineering/Robust_performance_controller_block'
 * '<S9>'   : 'Feedforward_tunning_model_Control_Engineering/Subsystem'
