...
void Feedforward_tunning_model_Control_Engineering_step0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  /* S-Function (dleadlag): '<S9>/Dctleadlag2' */

  /* Level2 S-Function Block: '<S9>/Dctleadlag2' (dleadlag) */
  {
    SimStruct *rts =
  ...
  /* S-Function (dnotch): '<S9>/Dctnotch3' */

  /* Level2 S-Function Block: '<S9>/Dctnotch3' (dnotch) */
  {
    SimStruct *rts =
  ...
  /* S-Function (dlowpass1): '<S9>/Dct1lowpass4' */

  /* Level2 S-Function Block: '<S9>/Dct1lowpass4' (dlowpass1) */
  {
    SimStruct *rts =
  ...
  /* S-Function (dnotch): '<S9>/Dctnotch5' */

  /* Level2 S-Function Block: '<S9>/Dctnotch5' (dnotch) */
  {
    SimStruct *rts =
  ...
  /* S-Function (dweakint): '<S9>/Dctintegrator6' */

  /* Level2 S-Function Block: '<S9>/Dctintegrator6' (dweakint) */
  {
    SimStruct *rts =
...
void Feedforward_tunning_model_Control_Engineering_initialize(void)
{
  ...
  Feedforward_tunning_model_Control_Engineering_M->Sizes.numSFcns = (8);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: Feedforward_tunning_model_Control_Engineering/<S8>/S-Function (ref3b) */
    {
      SimStruct *rts =
        Feedforward_tunning_model_Control_Engineering_M->childSfunctions[0];
    ...
    /* Level2 S-Function Block: Feedforward_tunning_model_Control_Engineering/<S9>/Dctleadlag2 (dleadlag) */
    {
      SimStruct *rts =
        Feedforward_tunning_model_Control_Engineering_M->childSfunctions[3];
      ...
      ssSetPath(rts,
                "Feedforward_tunning_model_Control_Engineering/colocated_final_controller/Dctleadlag2");
      ssSetRTModel(rts,Feedforward_tunning_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: Feedforward_tunning_model_Control_Engineering/<S9>/Dctnotch3 (dnotch) */
    {
      SimStruct *rts =
        Feedforward_tunning_model_Control_Engineering_M->childSfunctions[4];
      ...
      ssSetPath(rts,
                "Feedforward_tunning_model_Control_Engineering/colocated_final_controller/Dctnotch3");
      ssSetRTModel(rts,Feedforward_tunning_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: Feedforward_tunning_model_Control_Engineering/<S9>/Dct1lowpass4 (dlowpass1) */
    {
      SimStruct *rts =
        Feedforward_tunning_model_Control_Engineering_M->childSfunctions[5];
      ...
      ssSetPath(rts,
                "Feedforward_tunning_model_Control_Engineering/colocated_final_controller/Dct1lowpass4");
      ssSetRTModel(rts,Feedforward_tunning_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: Feedforward_tunning_model_Control_Engineering/<S9>/Dctnotch5 (dnotch) */
    {
      SimStruct *rts =
        Feedforward_tunning_model_Control_Engineering_M->childSfunctions[6];
      ...
      ssSetPath(rts,
                "Feedforward_tunning_model_Control_Engineering/colocated_final_controller/Dctnotch5");
      ssSetRTModel(rts,Feedforward_tunning_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: Feedforward_tunning_model_Control_Engineering/<S9>/Dctintegrator6 (dweakint) */
    {
      SimStruct *rts =
        Feedforward_tunning_model_Control_Engineering_M->childSfunctions[7];
      ...
      ssSetPath(rts,
                "Feedforward_tunning_model_Control_Engineering/colocated_final_controller/Dctintegrator6");
      ssSetRTModel(rts,Feedforward_tunning_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
  ...
  /* Start for S-Function (dleadlag): '<S9>/Dctleadlag2' */
  /* Level2 S-Function Block: '<S9>/Dctleadlag2' (dleadlag) */
  {
    SimStruct *rts =
      Feedforward_tunning_model_Control_Engineering_M->childSfunctions[3];
  ...
  /* Start for S-Function (dnotch): '<S9>/Dctnotch3' */
  /* Level2 S-Function Block: '<S9>/Dctnotch3' (dnotch) */
  {
    SimStruct *rts =
      Feedforward_tunning_model_Control_Engineering_M->childSfunctions[4];
  ...
  /* Start for S-Function (dlowpass1): '<S9>/Dct1lowpass4' */
  /* Level2 S-Function Block: '<S9>/Dct1lowpass4' (dlowpass1) */
  {
    SimStruct *rts =
      Feedforward_tunning_model_Control_Engineering_M->childSfunctions[5];
  ...
  /* Start for S-Function (dnotch): '<S9>/Dctnotch5' */
  /* Level2 S-Function Block: '<S9>/Dctnotch5' (dnotch) */
  {
    SimStruct *rts =
      Feedforward_tunning_model_Control_Engineering_M->childSfunctions[6];
  ...
  /* Start for S-Function (dweakint): '<S9>/Dctintegrator6' */
  /* Level2 S-Function Block: '<S9>/Dctintegrator6' (dweakint) */
  {
    SimStruct *rts =
      Feedforward_tunning_model_Control_Engineering_M->childSfunctions[7];
...
void Feedforward_tunning_model_Control_Engineering_terminate(void)
{
  ...
  /* Terminate for S-Function (dleadlag): '<S9>/Dctleadlag2' */
  /* Level2 S-Function Block: '<S9>/Dctleadlag2' (dleadlag) */
  {
    SimStruct *rts =
      Feedforward_tunning_model_Control_Engineering_M->childSfunctions[3];
  ...
  /* Terminate for S-Function (dnotch): '<S9>/Dctnotch3' */
  /* Level2 S-Function Block: '<S9>/Dctnotch3' (dnotch) */
  {
    SimStruct *rts =
      Feedforward_tunning_model_Control_Engineering_M->childSfunctions[4];
  ...
  /* Terminate for S-Function (dlowpass1): '<S9>/Dct1lowpass4' */
  /* Level2 S-Function Block: '<S9>/Dct1lowpass4' (dlowpass1) */
  {
    SimStruct *rts =
      Feedforward_tunning_model_Control_Engineering_M->childSfunctions[5];
  ...
  /* Terminate for S-Function (dnotch): '<S9>/Dctnotch5' */
  /* Level2 S-Function Block: '<S9>/Dctnotch5' (dnotch) */
  {
    SimStruct *rts =
      Feedforward_tunning_model_Control_Engineering_M->childSfunctions[6];
  ...
  /* Terminate for S-Function (dweakint): '<S9>/Dctintegrator6' */
  /* Level2 S-Function Block: '<S9>/Dctintegrator6' (dweakint) */
  {
    SimStruct *rts =
      Feedforward_tunning_model_Control_Engineering_M->childSfunctions[7];
