/*
 * Basic_controller_model_Control_Engineering.h
 *
 ...
 * C source code generated on : Wed Mar 27 10:10:40 2024
 *
...
#ifndef RTW_HEADER_Basic_controller_model_Control_Engineering_h_
#define RTW_HEADER_Basic_controller_model_Control_Engineering_h_
#ifndef Basic_controller_model_Control_Engineering_COMMON_INCLUDES_
#define Basic_controller_model_Control_Engineering_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif         /* Basic_controller_model_Control_Engineering_COMMON_INCLUDES_ */
...
typedef struct {
  ...
  real_T Dctintegrator3;               /* '<S1>/Dctintegrator3' */
...
typedef struct {
  ...
  real_T Dctintegrator3_RWORK[2];      /* '<S1>/Dctintegrator3' */
  ...
  uint8_T is_active_c1_Basic_controller_m;/* '<S3>/SPERTE_measurement_function' */
...
struct P_Basic_controller_model_Control_Engineering_T_ {
...
struct tag_RTM_Basic_controller_model_Control_Engineering_T {
...
extern P_Basic_controller_model_Control_Engineering_T
  Basic_controller_model_Control_Engineering_P;

/* Block signals (default storage) */
extern B_Basic_controller_model_Control_Engineering_T
  Basic_controller_model_Control_Engineering_B;

/* Block states (default storage) */
extern DW_Basic_controller_model_Control_Engineering_T
  Basic_controller_model_Control_Engineering_DW;

/* External function called from main */
extern void Basic_controller_model_Control_Engineering_SetEventsForThisBaseStep
  (boolean_T *eventFlags);

/* Model entry point functions */
extern void Basic_controller_model_Control_Engineering_initialize(void);
extern void Basic_controller_model_Control_Engineering_step0(void);
extern void Basic_controller_model_Control_Engineering_step2(void);
extern void Basic_controller_model_Control_Engineering_step(int_T tid);
extern void Basic_controller_model_Control_Engineering_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Basic_controller_model_Control_Engineering_T *const
 ...
 *
 * '<Root>' : 'Basic_controller_model_Control_Engineering'
 * '<S1>'   : 'Basic_controller_model_Control_Engineering/Basic_controller_block'
 * '<S2>'   : 'Basic_controller_model_Control_Engineering/Fourth Order Motion System'
 * '<S3>'   : 'Basic_controller_model_Control_Engineering/Measurement Block'
 * '<S4>'   : 'Basic_controller_model_Control_Engineering/Real-time scope'
 * '<S5>'   : 'Basic_controller_model_Control_Engineering/Ref power'
 * '<S6>'   : 'Basic_controller_model_Control_Engineering/Subsystem'
 * '<S7>'   : 'Basic_controller_model_Control_Engineering/Fourth Order Motion System/Ethercat E-box'
 * '<S8>'   : 'Basic_controller_model_Control_Engineering/Fourth Order Motion System/Ethercat Supervisor'
 * '<S9>'   : 'Basic_controller_model_Control_Engineering/Measurement Block/SPERTE_measurement_function'
 */
#endif            /* RTW_HEADER_Basic_controller_model_Control_Engineering_h_ */
