...
t = linspace(0,4.5 ,23000);
figure
plot(t',Untuned_error(1:23000), 'Color', [0, 0, 1, 0.1], 'LineWidth', 1.5); % Blue line for Untuned_error with alpha value 0.5
...
% Tuned Kfc
plot(t',Error_kfc(1:23000), 'Color', [1, 0, 0, 0.5], 'LineStyle', '--', 'LineWidth', 1); % Red dashed line for Error_kfc with alpha value 0.5

% Tuned Kfc and Kfa
plot(t',Error_kfv(1:23000), 'Color', [0.549, 0.251, 0, 1], 'LineStyle', '--', 'LineWidth', 1); 
%0.102, 0.788, 1
% Tuned Kfc, Kfa and Kfv
plot(t',Error_kfa(1:23000), 'Color', [0, 1, 0, 1], 'LineStyle', '--', 'LineWidth', 1); 
%1, 0.71, 0.549,
legend('Untuned Error', 'Tuned Error (Kfc)', 'Tuned Error (Kfv)', 'Tuned Error (Kfa) '); % Adding legends for each plot

%%
hold on; % To keep the existing plot and add highlighted sections

% Define the sections to highlight
sections = [0.3,2.08 ; 2.36, 4.11]; % Define intervals to highlight
