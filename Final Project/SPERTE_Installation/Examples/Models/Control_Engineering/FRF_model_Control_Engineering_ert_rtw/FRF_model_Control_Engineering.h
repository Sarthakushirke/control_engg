...
typedef struct {
  ...
  real_T Dctnotch6;                    /* '<S6>/Dctnotch6' */
  real_T Dctintegrator7;               /* '<S6>/Dctintegrator7' */
  real_T Dctnotch8;                    /* '<S6>/Dctnotch8' */
...
typedef struct {
  ...
  real_T Dctnotch6_RWORK[4];           /* '<S6>/Dctnotch6' */
  real_T Dctintegrator7_RWORK[2];      /* '<S6>/Dctintegrator7' */
  real_T Dctnotch8_RWORK[4];           /* '<S6>/Dctnotch8' */
...
struct P_FRF_model_Control_Engineering_T_ {
  ...
  real_T Noise_Seed;                   /* Expression: 0
                                        * Referenced by: '<Root>/Noise'
                                        */
  real_T Gain1_Gain;                   /* Expression: 0.29
  ...
  real_T Dctintegrator7_P1_Size[2];/* Computed Parameter: Dctintegrator7_P1_Size
                                    * Referenced by: '<S6>/Dctintegrator7'
                                    */
 ...
 * '<S6>'   : 'FRF_model_Control_Engineering/Superman_Robust_performance_controller_block'
