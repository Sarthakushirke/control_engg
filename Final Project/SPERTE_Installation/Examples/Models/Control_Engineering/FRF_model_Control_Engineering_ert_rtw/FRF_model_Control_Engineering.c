 ...
 * C source code generated on : Thu Apr  4 10:47:22 2024
 *
...
void FRF_model_Control_Engineering_step0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  /* S-Function (dnotch): '<S6>/Dctnotch6' */

  /* Level2 S-Function Block: '<S6>/Dctnotch6' (dnotch) */
  {
    SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[4];
    sfcnOutputs(rts,0);
  }

  /* S-Function (dweakint): '<S6>/Dctintegrator7' */

  /* Level2 S-Function Block: '<S6>/Dctintegrator7' (dweakint) */
  {
    SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[5];
    sfcnOutputs(rts,0);
  }

  /* S-Function (dnotch): '<S6>/Dctnotch8' */

  /* Level2 S-Function Block: '<S6>/Dctnotch8' (dnotch) */
  {
    ...
    if (FRF_model_Control_Engineering_DW.NS <
      ...
      if (!(f == NULL)) {
        ...
        FRF_model_Control_Engineering_B.xout[1] = (real32_T)
          FRF_model_Control_Engineering_B.Dctnotch8;
  ...
  {
    SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[8];
    sfcnOutputs(rts,0);
  }
  ...
  {
    SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[9];
    sfcnOutputs(rts,0);
  }
...
void FRF_model_Control_Engineering_initialize(void)
{
  ...
  /* External mode info */
  FRF_model_Control_Engineering_M->Sizes.checksums[0] = (1808017628U);
  FRF_model_Control_Engineering_M->Sizes.checksums[1] = (4227641204U);
  FRF_model_Control_Engineering_M->Sizes.checksums[2] = (2719944020U);
  FRF_model_Control_Engineering_M->Sizes.checksums[3] = (578259491U);
  ...
  FRF_model_Control_Engineering_M->Sizes.numSFcns = (10);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: FRF_model_Control_Engineering/<S6>/Dctleadlag2 (dleadlag) */
    {
      ...
      ssSetPath(rts,
                "FRF_model_Control_Engineering/Superman_Robust_performance_controller_block/Dctleadlag2");
    ...
    /* Level2 S-Function Block: FRF_model_Control_Engineering/<S6>/Dctnotch3 (dnotch) */
    {
      ...
      ssSetPath(rts,
                "FRF_model_Control_Engineering/Superman_Robust_performance_controller_block/Dctnotch3");
      ssSetRTModel(rts,FRF_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: FRF_model_Control_Engineering/<S6>/Dct1lowpass4 (dlowpass1) */
    {
      ...
      ssSetPath(rts,
                "FRF_model_Control_Engineering/Superman_Robust_performance_controller_block/Dct1lowpass4");
      ssSetRTModel(rts,FRF_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: FRF_model_Control_Engineering/<S6>/Dctnotch5 (dnotch) */
    {
      ...
      ssSetPath(rts,
                "FRF_model_Control_Engineering/Superman_Robust_performance_controller_block/Dctnotch5");
      ssSetRTModel(rts,FRF_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: FRF_model_Control_Engineering/<S6>/Dctnotch6 (dnotch) */
    {
      SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[4];
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          ssSetOutputPortWidthAsInt(rts, 0, 1);
          ssSetOutputPortSignal(rts, 0, ((real_T *)
            &FRF_model_Control_Engineering_B.Dctnotch6));
        }
      }
      ...
      ssSetPath(rts,
                "FRF_model_Control_Engineering/Superman_Robust_performance_controller_block/Dctnotch6");
      ssSetRTModel(rts,FRF_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctnotch6_P1_Size);
        ssSetSFcnParam(rts, 1, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctnotch6_P2_Size);
        ssSetSFcnParam(rts, 2, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctnotch6_P3_Size);
        ssSetSFcnParam(rts, 3, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctnotch6_P4_Size);
        ssSetSFcnParam(rts, 4, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctnotch6_P5_Size);
      }

      /* work vectors */
      ssSetRWork(rts, (real_T *)
                 &FRF_model_Control_Engineering_DW.Dctnotch6_RWORK[0]);

      {
        ...
        ssSetDWorkDataType(rts, 0,SS_DOUBLE);
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &FRF_model_Control_Engineering_DW.Dctnotch6_RWORK[0]);
      }
    ...
    /* Level2 S-Function Block: FRF_model_Control_Engineering/<S6>/Dctintegrator7 (dweakint) */
    {
      SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[5];
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
          ...
          sfcnUPtrs[0] = &FRF_model_Control_Engineering_B.Dctnotch6;
          ssSetInputPortSignalPtrs(rts, 0, (InputPtrsType)&sfcnUPtrs[0]);
          _ssSetInputPortNumDimensions(rts, 0, 1);
          ssSetInputPortWidthAsInt(rts, 0, 1);
        }
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          ssSetOutputPortWidthAsInt(rts, 0, 1);
          ssSetOutputPortSignal(rts, 0, ((real_T *)
            &FRF_model_Control_Engineering_B.Dctintegrator7));
        }
      }
      ...
      ssSetPath(rts,
                "FRF_model_Control_Engineering/Superman_Robust_performance_controller_block/Dctintegrator7");
      ssSetRTModel(rts,FRF_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctintegrator7_P1_Size);
        ssSetSFcnParam(rts, 1, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctintegrator7_P2_Size);
      }

      /* work vectors */
      ssSetRWork(rts, (real_T *)
                 &FRF_model_Control_Engineering_DW.Dctintegrator7_RWORK[0]);
    ...
    /* Level2 S-Function Block: FRF_model_Control_Engineering/<S6>/Dctnotch8 (dnotch) */
    {
      SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[6];
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
          ...
          sfcnUPtrs[0] = &FRF_model_Control_Engineering_B.Dctintegrator7;
          ssSetInputPortSignalPtrs(rts, 0, (InputPtrsType)&sfcnUPtrs[0]);
          _ssSetInputPortNumDimensions(rts, 0, 1);
          ssSetInputPortWidthAsInt(rts, 0, 1);
        }
      ...
      ssSetPath(rts,
                "FRF_model_Control_Engineering/Superman_Robust_performance_controller_block/Dctnotch8");
      ssSetRTModel(rts,FRF_model_Control_Engineering_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctnotch8_P1_Size);
        ssSetSFcnParam(rts, 1, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctnotch8_P2_Size);
        ssSetSFcnParam(rts, 2, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctnotch8_P3_Size);
        ssSetSFcnParam(rts, 3, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctnotch8_P4_Size);
        ssSetSFcnParam(rts, 4, (mxArray*)
                       FRF_model_Control_Engineering_P.Dctnotch8_P5_Size);
      }

      /* work vectors */
      ssSetRWork(rts, (real_T *)
                 &FRF_model_Control_Engineering_DW.Dctnotch8_RWORK[0]);

      {
        ...
        ssSetDWorkDataType(rts, 0,SS_DOUBLE);
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &FRF_model_Control_Engineering_DW.Dctnotch8_RWORK[0]);
      }
    ...
    /* Level2 S-Function Block: FRF_model_Control_Engineering/<S1>/Dctpd (dpd) */
    {
      ...
      /* timing info */
      time_T *sfcnPeriod =
        FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.sfcnPeriod;
      time_T *sfcnOffset =
        FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.sfcnOffset;
      int_T *sfcnTsMap =
        FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.sfcnTsMap;
      (void) memset((void*)sfcnPeriod, 0,
                    sizeof(time_T)*1);
      (void) memset((void*)sfcnOffset, 0,
                    sizeof(time_T)*1);
      ...
      _ssSetBlkInfo2PortInfo2Ptr(rts,
        &FRF_model_Control_Engineering_M->NonInlinedSFcns.inputOutputPortInfo2[8]);
      ...
      /* Allocate memory for states auxilliary information */
      {
        ssSetStatesInfo2(rts,
                         ...
                         [8]);
        ssSetPeriodicStatesInfo(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.periodicStatesInfo[8]);
      }
      ...
      /* inputs */
      {
        _ssSetNumInputPorts(rts, 1);
        ssSetPortInfoForInputs(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.inputPortInfo
          [0]);
        ssSetPortInfoForInputs(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.inputPortInfo
          [0]);
        ...
        ssSetInputPortUnit(rts, 0, 0);
        _ssSetPortInfo2ForInputCoSimAttribute(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.inputPortCoSimAttribute
          [0]);
        ssSetInputPortIsContinuousQuantity(rts, 0, 0);
        ...
        {
          real_T const **sfcnUPtrs = (real_T const **)
            &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.UPtrs0;
      ...
      /* outputs */
      {
        ...
        _ssSetNumOutputPorts(rts, 1);
        _ssSetPortInfo2ForOutputUnits(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.outputPortUnits
          [0]);
        ssSetOutputPortUnit(rts, 0, 0);
        _ssSetPortInfo2ForOutputCoSimAttribute(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.outputPortCoSimAttribute
          [0]);
        ssSetOutputPortIsContinuousQuantity(rts, 0, 0);
      ...
      {
        mxArray **sfcnParams = (mxArray **)
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.params;
        ssSetSFcnParamsCount(rts, 3);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)
      ...
      {
        struct _ssDWorkRecord *dWorkRecord = (struct _ssDWorkRecord *)
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.dWork;
        struct _ssDWorkAuxRecord *dWorkAuxRecord = (struct _ssDWorkAuxRecord *)
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn8.dWorkAux;
        ssSetSFcnDWork(rts, dWorkRecord);
        ssSetSFcnDWorkAux(rts, dWorkAuxRecord);
        ssSetNumDWorkAsInt(rts, 1);
    ...
    /* Level2 S-Function Block: FRF_model_Control_Engineering/<S1>/Dct2lowpass (dlowpass2) */
    {
      ...
      /* timing info */
      time_T *sfcnPeriod =
        FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.sfcnPeriod;
      time_T *sfcnOffset =
        FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.sfcnOffset;
      int_T *sfcnTsMap =
        FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.sfcnTsMap;
      (void) memset((void*)sfcnPeriod, 0,
                    sizeof(time_T)*1);
      (void) memset((void*)sfcnOffset, 0,
                    sizeof(time_T)*1);
      ...
      _ssSetBlkInfo2PortInfo2Ptr(rts,
        &FRF_model_Control_Engineering_M->NonInlinedSFcns.inputOutputPortInfo2[9]);
      ...
      /* Allocate memory for states auxilliary information */
      {
        ssSetStatesInfo2(rts,
                         ...
                         [9]);
        ssSetPeriodicStatesInfo(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.periodicStatesInfo[9]);
      }
      ...
      /* inputs */
      {
        _ssSetNumInputPorts(rts, 1);
        ssSetPortInfoForInputs(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.inputPortInfo
          [0]);
        ssSetPortInfoForInputs(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.inputPortInfo
          [0]);
        ...
        ssSetInputPortUnit(rts, 0, 0);
        _ssSetPortInfo2ForInputCoSimAttribute(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.inputPortCoSimAttribute
          [0]);
        ssSetInputPortIsContinuousQuantity(rts, 0, 0);
        ...
        {
          real_T const **sfcnUPtrs = (real_T const **)
            &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.UPtrs0;
      ...
      /* outputs */
      {
        ...
        _ssSetNumOutputPorts(rts, 1);
        _ssSetPortInfo2ForOutputUnits(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.outputPortUnits
          [0]);
        ssSetOutputPortUnit(rts, 0, 0);
        _ssSetPortInfo2ForOutputCoSimAttribute(rts,
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.outputPortCoSimAttribute
          [0]);
        ssSetOutputPortIsContinuousQuantity(rts, 0, 0);
      ...
      {
        mxArray **sfcnParams = (mxArray **)
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.params;
        ssSetSFcnParamsCount(rts, 3);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)
      ...
      {
        struct _ssDWorkRecord *dWorkRecord = (struct _ssDWorkRecord *)
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.dWork;
        struct _ssDWorkAuxRecord *dWorkAuxRecord = (struct _ssDWorkAuxRecord *)
          &FRF_model_Control_Engineering_M->NonInlinedSFcns.Sfcn9.dWorkAux;
        ssSetSFcnDWork(rts, dWorkRecord);
        ssSetSFcnDWorkAux(rts, dWorkAuxRecord);
        ssSetNumDWorkAsInt(rts, 1);
  ...
  /* Start for S-Function (dnotch): '<S6>/Dctnotch6' */
  /* Level2 S-Function Block: '<S6>/Dctnotch6' (dnotch) */
  {
    SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[4];
    sfcnStart(rts);
  ...
  /* Start for S-Function (dweakint): '<S6>/Dctintegrator7' */
  /* Level2 S-Function Block: '<S6>/Dctintegrator7' (dweakint) */
  {
    SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[5];
    sfcnStart(rts);
  ...
  /* Start for S-Function (dnotch): '<S6>/Dctnotch8' */
  /* Level2 S-Function Block: '<S6>/Dctnotch8' (dnotch) */
  {
    SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[6];
    sfcnStart(rts);
...
void FRF_model_Control_Engineering_terminate(void)
{
  ...
  /* Terminate for S-Function (dnotch): '<S6>/Dctnotch6' */
  /* Level2 S-Function Block: '<S6>/Dctnotch6' (dnotch) */
  {
    SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[4];
    sfcnTerminate(rts);
  ...
  /* Terminate for S-Function (dweakint): '<S6>/Dctintegrator7' */
  /* Level2 S-Function Block: '<S6>/Dctintegrator7' (dweakint) */
  {
    SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[5];
    sfcnTerminate(rts);
  ...
  /* Terminate for S-Function (dnotch): '<S6>/Dctnotch8' */
  /* Level2 S-Function Block: '<S6>/Dctnotch8' (dnotch) */
  {
    SimStruct *rts = FRF_model_Control_Engineering_M->childSfunctions[6];
    sfcnTerminate(rts);
