...
void Feedforward_tunning_model_Control_Engineering_step0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (Feedforward_tunning_model_Control_Engineering_B.Error >
      Feedforward_tunning_model_Control_Engineering_P.Saturation_UpperSat) {
    Feedforward_tunning_model_Control_Engineering_B.y =
      Feedforward_tunning_model_Control_Engineering_P.Saturation_UpperSat;
  } else if (Feedforward_tunning_model_Control_Engineering_B.Error <
  ...
  if (Feedforward_tunning_model_Control_Engineering_B.y >
    ...
    Feedforward_tunning_model_Control_Engineering_B.Saturation[0] =
      Feedforward_tunning_model_Control_Engineering_P.Saturation_UpperSat_d;
  } else if (Feedforward_tunning_model_Control_Engineering_B.y <
...
void Feedforward_tunning_model_Control_Engineering_initialize(void)
{
  ...
  Feedforward_tunning_model_Control_Engineering_M->Sizes.numSFcns = (3);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: Feedforward_tunning_model_Control_Engineering/<S10>/S-Function (ec_Supervisor) */
    {
      SimStruct *rts =
        Feedforward_tunning_model_Control_Engineering_M->childSfunctions[1];
    ...
    /* Level2 S-Function Block: Feedforward_tunning_model_Control_Engineering/<S9>/ec_Ebox (ec_Ebox) */
    {
      SimStruct *rts =
        Feedforward_tunning_model_Control_Engineering_M->childSfunctions[2];
