...
% ModelName = 'Basic_controller_model_Control_Engineering';
ModelName = 'FRF_model_Control_Engineering';
...
% set_param(BlockPaths{Index_noise},'variance','0.5');
% pause(0.1);
...
y = measurement(:,2);
%Closed loop Error
closed_loop_error = measurement(:,3);
%constant_velocity loop Error
% constant_velocity = measurement(:,4);
